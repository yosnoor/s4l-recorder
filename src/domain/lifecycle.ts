 ...
 */
export function markRecordingRecoverable(current: InterviewLifecycle): 'RECORDING_RECOVERABLE' {
  if (current !== 'RECORDING') {
    throw new Error(
 ...
 */
export function beginUpload(current: RecordingPersistence): 'UPLOAD_IN_PROGRESS' {
 ...
 */
export function confirmRemote(current: RecordingPersistence): 'REMOTE_CONFIRMED' {
 ...
 */
export function retryUpload(current: RecordingPersistence): 'UPLOAD_IN_PROGRESS' {
 ...
 */
export function beginTransfer(current: DeliveryLifecycle): 'TRANSFER_IN_PROGRESS' {
  if (current !== 'NOT_SENT') {
    throw new Error(
 ...
 */
export function confirmTransfer(current: DeliveryLifecycle): 'TRANSFER_CREATED' {
 ...
 */
export function retryTransfer(current: DeliveryLifecycle): 'TRANSFER_IN_PROGRESS' {
